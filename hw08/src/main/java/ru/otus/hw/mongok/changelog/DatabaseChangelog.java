...
public class DatabaseChangelog {
    ...
    public void insertComments(CommentRepository commentRepository) {
        commentRepository.save(new Comment("1", book1, "First Comment"));
        commentRepository.save(new Comment("2", book2, "Second Comment"));
        commentRepository.save(new Comment("3", book3, "Third Comment"));
    }
}
