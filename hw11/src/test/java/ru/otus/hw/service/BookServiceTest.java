...
class BookServiceTest {
    ...
    void shouldAddNewBook() {
        var insertedBook = bookService.insert(new BookDto(null, "Test_Title_book", 1L, Set.of(1L)));
    ...
    void shouldThrowEntityNotFoundExceptionAtInsert() {
        assertThrows(EntityNotFoundException.class, () -> bookService.insert(new BookDto(null, "Test_Title_book", 99L, Set.of(1L))));
    }
    ...
    void shouldUpdateBook() {
        ...
        var updatedBook = bookService.update(new BookDto(oldBook.getId(), "Title", oldBook.getAuthor().getId(), genreIds));
    ...
    void shouldThrowEntityNotFoundExceptionAtUpdate() {
        ...
        assertThrows(EntityNotFoundException.class,
                () -> bookService.update(new BookDto(oldBook.getId(), "Title", 99L, genreIds)));
    }
